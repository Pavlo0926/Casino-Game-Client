...
public class BigEyeRoad : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        blueMarker = Resources.Load<Sprite>("Roadmap/Symbols/big_eye_boy_blue");
        redMarker = Resources.Load<Sprite>("Roadmap/Symbols/big_eye_boy_red");
    ...
    public void LoadData(RoadmapData data)
    {
        ...
        var results = service.GenerateCycleResultsForBigRoad(bigRoad, 1);
