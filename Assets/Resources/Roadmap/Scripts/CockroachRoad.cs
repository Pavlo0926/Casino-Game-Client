...
public class CockroachRoad : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        blueMarker = Resources.Load<Sprite>("Roadmap/Symbols/cockroach_blue");
        redMarker = Resources.Load<Sprite>("Roadmap/Symbols/cockroach_red");
    ...
    public void LoadData(RoadmapData data)
    {
        ...
        var results = service.GenerateCycleResultsForBigRoad(bigRoad, 3);
